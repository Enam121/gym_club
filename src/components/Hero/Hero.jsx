                            ...
                            <div className="bannerTextDiv">
                                <div className="text-white fw-bolder">
                                    ...
                                    <Fade left>
                                        ...
                                        <button className="btn fs-3 bg-success bg-gradient herobtn fw-bold rounded-3 shadow-lg border-0 px-5 py-3 text-light">Know More<i className="fas fa-arrow-right ms-2"></i></button>
