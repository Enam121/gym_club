                ...
                <Container>
                    ...
                    <Fade bottom>
                            <div className="">
                                ...
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Fit Club in a nutshel</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">What we do</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">History</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Location</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Management Team</Link>
                            </div>
                        </Fade>
                        </Col>
                        ...
                        <Fade bottom>
                            <div className="">
                                ...
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Overview</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Classes altenrnate</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Class pricing</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Signle class</Link>
                                <Link className="text-decoration-none border-btm pb-2 fs-6 d-block text-white" to="/">Find Out More</Link>
                            </div>
                        </Fade>
                        </Col>
