                                ...
                                <div className="card h-100 border-0 shadow-lg rounded-3 position-relative ">
                                    ...
                                    <div>
                                        <div className="d-flex justify-content-between bg-white ">
                                            <Link to={`/cart/${s.id}`} className="btn btn-light btnMore  ">Enroll Now</Link>
                                            <Link to={`/service/${s.id}`} className="btn btn-light btnMore">More Details<i className="fas fa-arrow-right ms-2"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
